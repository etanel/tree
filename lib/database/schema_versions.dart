...
// ── Schema47: adds habits + habit_logs ─────────────────────────────────────
...
final class Schema47 extends i0.VersionedSchema {
  ...
  late final Shape18 deleteLogs = Shape18(
      ...
      alias: null);
  late final Shape37 habits = Shape37(
      source: i0.VersionedTable(
        entityName: 'habits',
        withoutRowId: false,
        isStrict: false,
      ...
      alias: null);
  late final Shape38 habitLogs = Shape38(
      source: i0.VersionedTable(
        entityName: 'habit_logs',
        withoutRowId: false,
        isStrict: false,
        tableConstraints: [
          'PRIMARY KEY(habit_log_pk)',
        ],
        columns: [
          _column_106,
          _column_107,
...
class Shape37 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get habitPk =>
      columnsByName['habit_pk']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get name =>
      columnsByName['name']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get note =>
      columnsByName['note']! as i1.GeneratedColumn<String>;
  ...
  i1.GeneratedColumn<String> get frequencyDays =>
      columnsByName['frequency_days']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<double> get goalAmount =>
      columnsByName['goal_amount']! as i1.GeneratedColumn<double>;
  i1.GeneratedColumn<String> get goalUnit =>
      columnsByName['goal_unit']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<bool> get reminderEnabled =>
      columnsByName['reminder_enabled']! as i1.GeneratedColumn<bool>;
  i1.GeneratedColumn<String> get reminderTime =>
      columnsByName['reminder_time']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<DateTime> get startDate =>
      columnsByName['start_date']! as i1.GeneratedColumn<DateTime>;
  i1.GeneratedColumn<DateTime> get endDate =>
      columnsByName['end_date']! as i1.GeneratedColumn<DateTime>;
...
class Shape38 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get habitLogPk =>
      columnsByName['habit_log_pk']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get habitFk =>
      columnsByName['habit_fk']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<DateTime> get dateCreated =>
      columnsByName['date_created']! as i1.GeneratedColumn<DateTime>;
  i1.GeneratedColumn<double> get amount =>
      columnsByName['amount']! as i1.GeneratedColumn<double>;
...
i1.GeneratedColumn<String> _column_99(String aliasedName) =>
    i1.GeneratedColumn<String>('habit_pk', aliasedName, false,
        type: i1.DriftSqlType.string);
i1.GeneratedColumn<int> _column_100(String aliasedName) =>
    i1.GeneratedColumn<int>('frequency', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: Constant(0));
i1.GeneratedColumn<String> _column_101(String aliasedName) =>
    i1.GeneratedColumn<String>('frequency_days', aliasedName, true,
        type: i1.DriftSqlType.string);
i1.GeneratedColumn<double> _column_102(String aliasedName) =>
    i1.GeneratedColumn<double>('goal_amount', aliasedName, true,
        type: i1.DriftSqlType.double);
i1.GeneratedColumn<String> _column_103(String aliasedName) =>
    i1.GeneratedColumn<String>('goal_unit', aliasedName, true,
        additionalChecks: i1.GeneratedColumn.checkTextLength(),
        type: i1.DriftSqlType.string);
i1.GeneratedColumn<bool> _column_104(String aliasedName) =>
    i1.GeneratedColumn<bool>('reminder_enabled', aliasedName, false,
        type: i1.DriftSqlType.bool,
        defaultConstraints: i1.GeneratedColumn.constraintIsAlways(
            'CHECK ("reminder_enabled" IN (0, 1))'),
        defaultValue: const Constant(false));
i1.GeneratedColumn<String> _column_105(String aliasedName) =>
    i1.GeneratedColumn<String>('reminder_time', aliasedName, true,
        type: i1.DriftSqlType.string);
i1.GeneratedColumn<String> _column_106(String aliasedName) =>
    i1.GeneratedColumn<String>('habit_log_pk', aliasedName, false,
        type: i1.DriftSqlType.string);
i1.GeneratedColumn<String> _column_107(String aliasedName) =>
    i1.GeneratedColumn<String>('habit_fk', aliasedName, false,
        type: i1.DriftSqlType.string,
        defaultConstraints: i1.GeneratedColumn.constraintIsAlways(
            'REFERENCES habits (habit_pk)'));
