...
class $HabitsTable extends Habits with TableInfo<$HabitsTable, Habit> {
  ...
  static const VerificationMeta _habitPkMeta =
      const VerificationMeta('habitPk');
  @override
  late final GeneratedColumn<String> habitPk = GeneratedColumn<String>(
      'habit_pk', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      clientDefault: () => uuid.v4());
  static const VerificationMeta _nameMeta = const VerificationMeta('name');
  ...
  late final GeneratedColumnWithTypeConverter<List<int>?, String>
      frequencyDays = GeneratedColumn<String>(
              'frequency_days', aliasedName, true,
              type: DriftSqlType.string, requiredDuringInsert: false)
          .withConverter<List<int>?>($HabitsTable.$converterfrequencyDaysn);
  ...
  VerificationContext validateIntegrity(Insertable<Habit> instance,
    ...
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('habit_pk')) {
      context.handle(_habitPkMeta,
          habitPk.isAcceptableOrUnknown(data['habit_pk']!, _habitPkMeta));
    }
    if (data.containsKey('name')) {
      context.handle(
          _nameMeta, name.isAcceptableOrUnknown(data['name']!, _nameMeta));
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {habitPk};
  @override
  Habit map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return Habit(
      habitPk: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}habit_pk'])!,
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
      note: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}note'])!,
      ...
      frequencyDays: $HabitsTable.$converterfrequencyDaysn.fromSql(
          attachedDatabase.typeMapping.read(
              DriftSqlType.string, data['${effectivePrefix}frequency_days'])),
  ...
  static TypeConverter<List<int>, String> $converterfrequencyDays =
      const IntListInColumnConverter();
  static TypeConverter<List<int>?, String?> $converterfrequencyDaysn =
      NullAwareTypeConverter.wrap($converterfrequencyDays);
}
...
class Habit extends DataClass implements Insertable<Habit> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['habit_pk'] = Variable<String>(habitPk);
    map['name'] = Variable<String>(name);
    map['note'] = Variable<String>(note);
    if (!nullToAbsent || colour != null) {
      map['colour'] = Variable<String>(colour);
    ...
    {
      map['frequency'] =
          Variable<int>($HabitsTable.$converterfrequency.toSql(frequency));
    }
    if (!nullToAbsent || frequencyDays != null) {
      map['frequency_days'] = Variable<String>(
          $HabitsTable.$converterfrequencyDaysn.toSql(frequencyDays));
    }
  ...
  factory Habit.fromJson(Map<String, dynamic> json,
    ...
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return Habit(
      habitPk: serializer.fromJson<String>(json['habitPk']),
      name: serializer.fromJson<String>(json['name']),
      note: serializer.fromJson<String>(json['note']),
      colour: serializer.fromJson<String?>(json['colour']),
      iconName: serializer.fromJson<String?>(json['iconName']),
      ...
      pinned: serializer.fromJson<bool>(json['pinned']),
      archived: serializer.fromJson<bool>(json['archived']),
      frequency: $HabitsTable.$converterfrequency
          .fromJson(serializer.fromJson<int>(json['frequency'])),
      frequencyDays: serializer.fromJson<List<int>?>(json['frequencyDays']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return <String, dynamic>{
      'habitPk': serializer.toJson<String>(habitPk),
      'name': serializer.toJson<String>(name),
      'note': serializer.toJson<String>(note),
      'colour': serializer.toJson<String?>(colour),
      'iconName': serializer.toJson<String?>(iconName),
      ...
      'frequency': serializer
          .toJson<int>($HabitsTable.$converterfrequency.toJson(frequency)),
      'frequencyDays': serializer.toJson<List<int>?>(frequencyDays),
  ...
  Habit copyWith(
          ...
          Value<List<int>?> frequencyDays = const Value.absent(),
  ...
  Habit copyWithCompanion(HabitsCompanion data) {
    return Habit(
      habitPk: data.habitPk.present ? data.habitPk.value : this.habitPk,
      name: data.name.present ? data.name.value : this.name,
      note: data.note.present ? data.note.value : this.note,
      colour: data.colour.present ? data.colour.value : this.colour,
      iconName: data.iconName.present ? data.iconName.value : this.iconName,
...
class HabitsCompanion extends UpdateCompanion<Habit> {
  ...
  final Value<List<int>?> frequencyDays;
  ...
  const HabitsCompanion({
    this.habitPk = const Value.absent(),
    this.name = const Value.absent(),
    this.note = const Value.absent(),
    this.colour = const Value.absent(),
    this.iconName = const Value.absent(),
  ...
  static Insertable<Habit> custom({
    ...
    return RawValuesInsertable({
      if (habitPk != null) 'habit_pk': habitPk,
      if (name != null) 'name': name,
      if (note != null) 'note': note,
      if (colour != null) 'colour': colour,
      if (iconName != null) 'icon_name': iconName,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    if (habitPk.present) {
      map['habit_pk'] = Variable<String>(habitPk.value);
    }
    if (name.present) {
      map['name'] = Variable<String>(name.value);
    }
    ...
    if (frequencyDays.present) {
      map['frequency_days'] = Variable<String>(
          $HabitsTable.$converterfrequencyDaysn.toSql(frequencyDays.value));
    }
...
class $HabitLogsTable extends HabitLogs
  ...
  static const VerificationMeta _habitLogPkMeta =
      const VerificationMeta('habitLogPk');
  @override
  late final GeneratedColumn<String> habitLogPk = GeneratedColumn<String>(
      'habit_log_pk', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      clientDefault: () => uuid.v4());
  static const VerificationMeta _habitFkMeta =
      const VerificationMeta('habitFk');
  @override
  late final GeneratedColumn<String> habitFk = GeneratedColumn<String>(
      'habit_fk', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: true,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('REFERENCES habits (habit_pk)'));
  static const VerificationMeta _dateCreatedMeta =
      const VerificationMeta('dateCreated');
  @override
  late final GeneratedColumn<DateTime> dateCreated = GeneratedColumn<DateTime>(
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [habitLogPk, habitFk, dateCreated, amount, note, dateTimeModified];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  VerificationContext validateIntegrity(Insertable<HabitLog> instance,
    ...
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('habit_log_pk')) {
      context.handle(
          _habitLogPkMeta,
          habitLogPk.isAcceptableOrUnknown(
              data['habit_log_pk']!, _habitLogPkMeta));
    }
    if (data.containsKey('habit_fk')) {
      context.handle(_habitFkMeta,
          habitFk.isAcceptableOrUnknown(data['habit_fk']!, _habitFkMeta));
    } else if (isInserting) {
      context.missing(_habitFkMeta);
    }
    if (data.containsKey('date_created')) {
      context.handle(
          _dateCreatedMeta,
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {habitLogPk};
  @override
  HabitLog map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return HabitLog(
      habitLogPk: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}habit_log_pk'])!,
      habitFk: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}habit_fk'])!,
      dateCreated: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}date_created'])!,
      amount: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}amount']),
...
class HabitLog extends DataClass implements Insertable<HabitLog> {
  final String habitLogPk;
  final String habitFk;
  final DateTime dateCreated;
  final double? amount;
  final String? note;
  final DateTime? dateTimeModified;
  const HabitLog(
      {required this.habitLogPk,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['habit_log_pk'] = Variable<String>(habitLogPk);
    map['habit_fk'] = Variable<String>(habitFk);
    map['date_created'] = Variable<DateTime>(dateCreated);
  ...
  HabitLogsCompanion toCompanion(bool nullToAbsent) {
    return HabitLogsCompanion(
      habitLogPk: Value(habitLogPk),
      habitFk: Value(habitFk),
      dateCreated: Value(dateCreated),
      amount:
  ...
  factory HabitLog.fromJson(Map<String, dynamic> json,
    ...
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return HabitLog(
      habitLogPk: serializer.fromJson<String>(json['habitLogPk']),
      habitFk: serializer.fromJson<String>(json['habitFk']),
      dateCreated: serializer.fromJson<DateTime>(json['dateCreated']),
      amount: serializer.fromJson<double?>(json['amount']),
      note: serializer.fromJson<String?>(json['note']),
      dateTimeModified:
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return <String, dynamic>{
      'habitLogPk': serializer.toJson<String>(habitLogPk),
      'habitFk': serializer.toJson<String>(habitFk),
      'dateCreated': serializer.toJson<DateTime>(dateCreated),
      'amount': serializer.toJson<double?>(amount),
      'note': serializer.toJson<String?>(note),
      'dateTimeModified': serializer.toJson<DateTime?>(dateTimeModified),
  ...
  HabitLog copyWith(
          ...
          Value<DateTime?> dateTimeModified = const Value.absent()}) =>
      HabitLog(
        habitLogPk: habitLogPk ?? this.habitLogPk,
  ...
  HabitLog copyWithCompanion(HabitLogsCompanion data) {
    return HabitLog(
      habitLogPk:
          data.habitLogPk.present ? data.habitLogPk.value : this.habitLogPk,
      habitFk: data.habitFk.present ? data.habitFk.value : this.habitFk,
      dateCreated:
          data.dateCreated.present ? data.dateCreated.value : this.dateCreated,
      amount: data.amount.present ? data.amount.value : this.amount,
      note: data.note.present ? data.note.value : this.note,
  ...
  String toString() {
    return (StringBuffer('HabitLog(')
          ..write('habitLogPk: $habitLogPk, ')
          ..write('habitFk: $habitFk, ')
          ..write('dateCreated: $dateCreated, ')
          ..write('amount: $amount, ')
          ..write('note: $note, ')
          ..write('dateTimeModified: $dateTimeModified')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is HabitLog &&
          other.habitLogPk == this.habitLogPk &&
          other.habitFk == this.habitFk &&
          other.dateCreated == this.dateCreated &&
          other.amount == this.amount &&
          other.note == this.note &&
          other.dateTimeModified == this.dateTimeModified);
...
class HabitLogsCompanion extends UpdateCompanion<HabitLog> {
  final Value<String> habitLogPk;
  final Value<String> habitFk;
  final Value<DateTime> dateCreated;
  final Value<double?> amount;
  final Value<String?> note;
  final Value<DateTime?> dateTimeModified;
  ...
  const HabitLogsCompanion({
    this.habitLogPk = const Value.absent(),
    this.habitFk = const Value.absent(),
    this.dateCreated = const Value.absent(),
    this.amount = const Value.absent(),
    this.note = const Value.absent(),
    this.dateTimeModified = const Value.absent(),
  ...
  static Insertable<HabitLog> custom({
    Expression<String>? habitLogPk,
    Expression<String>? habitFk,
    Expression<DateTime>? dateCreated,
    Expression<double>? amount,
    Expression<String>? note,
    Expression<DateTime>? dateTimeModified,
    ...
    return RawValuesInsertable({
      if (habitLogPk != null) 'habit_log_pk': habitLogPk,
      if (habitFk != null) 'habit_fk': habitFk,
      if (dateCreated != null) 'date_created': dateCreated,
      if (amount != null) 'amount': amount,
      if (note != null) 'note': note,
      if (dateTimeModified != null) 'date_time_modified': dateTimeModified,
  ...
  HabitLogsCompanion copyWith(
      {Value<String>? habitLogPk,
      Value<String>? habitFk,
      Value<DateTime>? dateCreated,
      Value<double?>? amount,
      Value<String?>? note,
      Value<DateTime?>? dateTimeModified,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    if (habitLogPk.present) {
      map['habit_log_pk'] = Variable<String>(habitLogPk.value);
    }
    if (habitFk.present) {
      map['habit_fk'] = Variable<String>(habitFk.value);
    }
    if (dateCreated.present) {
      map['date_created'] = Variable<DateTime>(dateCreated.value);
    }
...
final class $$HabitsTableReferences
    extends BaseReferences<_$FinanceDatabase, $HabitsTable, Habit> {
  $$HabitsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static MultiTypedResultKey<$HabitLogsTable, List<HabitLog>>
      _habitLogsRefsTable(_$FinanceDatabase db) =>
          MultiTypedResultKey.fromTable(db.habitLogs,
              aliasName: $_aliasNameGenerator(
                  db.habits.habitPk, db.habitLogs.habitFk));

  $$HabitLogsTableProcessedTableManager get habitLogsRefs {
    final manager = $$HabitLogsTableTableManager($_db, $_db.habitLogs).filter(
        (f) => f.habitFk.habitPk.sqlEquals($_itemColumn<String>('habit_pk')!));
...
class $$HabitsTableFilterComposer
    extends Composer<_$FinanceDatabase, $HabitsTable> {
  ...
  ColumnFilters<String> get habitPk => $composableBuilder(
      column: $table.habitPk, builder: (column) => ColumnFilters(column));
  ...
  ColumnWithTypeConverterFilters<List<int>?, List<int>, String>
      get frequencyDays => $composableBuilder(
  ...
  Expression<bool> habitLogsRefs(
    ...
    final $$HabitLogsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.habitPk,
        referencedTable: $db.habitLogs,
        getReferencedColumn: (t) => t.habitFk,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
...
class $$HabitsTableOrderingComposer
  ...
  ColumnOrderings<String> get habitPk => $composableBuilder(
      column: $table.habitPk, builder: (column) => ColumnOrderings(column));
...
class $$HabitsTableAnnotationComposer
  ...
  GeneratedColumn<String> get habitPk =>
      $composableBuilder(column: $table.habitPk, builder: (column) => column);
  ...
  GeneratedColumnWithTypeConverter<List<int>?, String> get frequencyDays =>
      $composableBuilder(
...
class $$HabitsTableTableManager extends RootTableManager<
  ...
  $$HabitsTableTableManager(_$FinanceDatabase db, $HabitsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            Value<String> habitPk = const Value.absent(),
            Value<String> name = const Value.absent(),
            Value<String> note = const Value.absent(),
            Value<String?> colour = const Value.absent(),
            Value<String?> iconName = const Value.absent(),
                ...
                return [
                  if (habitLogsRefs)
                    await $_getPrefetchedData<Habit, $HabitsTable, HabitLog>(
                        ...
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.habitFk == item.habitPk),
                        typedResults: items)
                ];
              },
            );
...
final class $$HabitLogsTableReferences
    extends BaseReferences<_$FinanceDatabase, $HabitLogsTable, HabitLog> {
  $$HabitLogsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $HabitsTable _habitFkTable(_$FinanceDatabase db) =>
      db.habits.createAlias(
          $_aliasNameGenerator(db.habitLogs.habitFk, db.habits.habitPk));

  $$HabitsTableProcessedTableManager get habitFk {
    final $_column = $_itemColumn<String>('habit_fk')!;

    final manager = $$HabitsTableTableManager($_db, $_db.habits)
        .filter((f) => f.habitPk.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_habitFkTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: [item]));
  }
...
class $$HabitLogsTableFilterComposer
    extends Composer<_$FinanceDatabase, $HabitLogsTable> {
  $$HabitLogsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  ColumnFilters<String> get habitLogPk => $composableBuilder(
      column: $table.habitLogPk, builder: (column) => ColumnFilters(column));
  ...
  $$HabitsTableFilterComposer get habitFk {
    final $$HabitsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.habitFk,
        referencedTable: $db.habits,
        getReferencedColumn: (t) => t.habitPk,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
            $$HabitsTableFilterComposer(
...
class $$HabitLogsTableOrderingComposer
  ...
  ColumnOrderings<String> get habitLogPk => $composableBuilder(
      column: $table.habitLogPk, builder: (column) => ColumnOrderings(column));
  ...
  $$HabitsTableOrderingComposer get habitFk {
...
class $$HabitLogsTableAnnotationComposer
  ...
  GeneratedColumn<String> get habitLogPk => $composableBuilder(
      column: $table.habitLogPk, builder: (column) => column);
  ...
  $$HabitsTableAnnotationComposer get habitFk {
...
class $$HabitLogsTableTableManager extends RootTableManager<
    ...
    HabitLog,
    PrefetchHooks Function({bool habitFk})> {
  $$HabitLogsTableTableManager(_$FinanceDatabase db, $HabitLogsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            Value<String> habitLogPk = const Value.absent(),
            Value<String> habitFk = const Value.absent(),
            Value<DateTime> dateCreated = const Value.absent(),
            Value<double?> amount = const Value.absent(),
            Value<String?> note = const Value.absent(),
            Value<DateTime?> dateTimeModified = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({habitFk = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
                ...
                if (habitFk) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.habitFk,
                    referencedTable:
                        $$HabitLogsTableReferences._habitFkTable(db),
                    referencedColumn:
                        $$HabitLogsTableReferences._habitFkTable(db).habitPk,
                  ) as T;
                }
