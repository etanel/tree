...
import 'package:tree/pages/editBudgetLimitsPage.dart';
...
import 'package:tree/pages/sharedBudgetSettings.dart';
...
import 'package:tree/widgets/listItem.dart';
import 'package:tree/widgets/outlinedButtonStacked.dart';
import 'package:tree/widgets/sliverStickyLabelDivider.dart';
...
class _AddBudgetPageState extends State<AddBudgetPage> {
  ...
  void setSelectedShared(bool shared) {
    setState(() {
  ...
  void setAddedTransactionsOnly(bool addedOnly) {
    setState(() {
  ...
  void setSelectedBudgetFilters(List<BudgetTransactionFilters> filters) {
    setState(() {
  ...
  void setSelectedBudgetType(String item) {
  ...
  Future<void> discardChangesPopupIfBudgetPassed() async {
    Budget? currentInstance;
    if (widget.budget != null) {
      currentInstance =
          await database.getBudgetInstance(widget.budget!.budgetPk);
...
class _WalletChipSelectorState extends State<WalletChipSelector> {
  ...
  void onSelected(TransactionWallet? item) {
...
class _ViewBudgetTransactionFilterInfoState
  ...
  void onTap(BudgetTransactionFilters item) {
