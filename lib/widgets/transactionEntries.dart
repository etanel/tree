...
import 'package:tree/widgets/dateDivider.dart';
...
import 'package:tree/widgets/ghostTransactions.dart';
                          ...
                          Flexible(
                            child: CountNumber(
                              ...
                              textBuilder: (number) {
                                return TextFont(
                                  text:
                                      "= ${convertToMoney(Provider.of<AllWallets>(context), number, finalNumber: netSpending.abs())}",
                                  fontSize: 15,
